...
export const experiences = [
  {
    ...
    desc: "Buld music plugin for Zuri Apps using React Js with seamless interaction of REST APIs using AXIOS optimized with React Query. Refactored previous code to TypeScript, updated with new dependency and integrated Vite with Jest for Unit Testing.",
    skills: [
      "ReactJS",
      "Redux",
      "NodeJs",
...
"axios",
  ...
  },
  {
    ...
    company: "Qruse",
    date: "Jul 2023",
    desc: "Built a waitlist web App, with MVC Architecture using Next Js and TypeScript integrating MongoDB. Created Low Level Design and converted Figma design to actual code.",
    skills: [
      "Next Js",
      "TypeScript",
      "MongoDB",
...
export const education = [
  ...
  },
  {
    ...
    grade: "92.3%",
    desc: "I completed my Full-stack software engineering at Udacity, remotely where I Docker, Kubernetes, AWS, Ec2, Auth0, Database Management Systems, and more.",
...
export const projects = [
  {
    ...
    description:
      "An art application that helps artists to create, save, and showcase the art they create. It provides a user-friendly interface for artists to upload, edit, and manage their artworks.",
    image:
      artgrams,
    tags: [
      "Next Js",
    ...
    webapp: "https://artgram-project.vercel.app/",
     member: [
      ...
      },
      {
        ...
        img: "",
        linkedin: "",
        github: "https://github.com/jhuang10123",
